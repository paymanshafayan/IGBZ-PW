/**
 * لاگر هوشا (۰.۹.۶) — پیشینهٔ درخواست کارفرما: «بخشی برای بررسی کامل خطاها».
 *
 * سه لایه: بافر حلقوی در حافظه (برای صفحهٔ لاگ‌ها) + سطر JSON در
 * `~/.hoosha/logs/hoosha.log` (برای بررسی پس از کرش) + کانال‌های موضوعی
...
function logPath() {
	return path.join( String( HOME ), 'logs', 'hoosha.log' );
}
