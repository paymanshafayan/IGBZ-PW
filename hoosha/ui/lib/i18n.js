...
const EN = {
	...
	'موتور تونل داخلی هوشا': "Hoosha's built-in tunnel engine",
	'نشانی': 'Address',
	'درگاه': 'Port',
	'استثناها': 'Exceptions',
	...
	'Node.js پراکسی سیستم را نمی‌بیند؛ تماس‌های پرووایدر از مسیر انتخابی این‌جا می‌گذرند. مقصدهای استثنا‌شده همیشه مستقیم می‌مانند.': "Node.js can't see your system proxy; provider traffic goes through the route chosen here. Excepted targets always stay direct.",
	'تنظیمات پراکسی ذخیره شد.': 'Proxy settings saved.',
	'تست اتصال': 'Test connection',
	'موتور تونل داخلی': 'Built-in tunnel engine',
	'مثل یک v2ray داخل هوشا: کانفیگ‌های رایگان را از مخازن عمومی جمع می‌کند، می‌آزماید، سالم‌ها را نگه می‌دارد و درگاه محلی پایداری می‌سازد که خودکار روی بهترین می‌چرخد. هشدار: کانفیگ رایگان یعنی اپراتور ناشناس — برای کار حساس، سرور خودت را به منابع اضافه کن.': 'Like a v2ray inside Hoosha: collects free configs from public repos, tests them, keeps the working ones, and runs a stable local port that auto-rotates to the best. Warning: free configs mean unknown operators — for sensitive work add your own server to the sources.',
	...
	'زمینه': 'Context',
	'همهٔ رخدادها و خطاها با کانال و زمان. «زمینه» جزئیات JSON هر ردیف را باز می‌کند. نسخهٔ کامل روی دیسک: logs/hoosha.log در پوشهٔ خانگی هوشا.': 'All events and errors with channel and time. "Context" expands each row\'s JSON. Full copy on disk: logs/hoosha.log under the Hoosha home.',
	'کانال': 'Channel',
	'سطح': 'Level',
