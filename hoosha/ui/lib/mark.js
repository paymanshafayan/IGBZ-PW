...
export const COLORS = {
	/*
	 * نارنجیِ رسمی: Crail #d97757.
	 *
	 * قبلاً یک گرادیان دلبخواهی بود که نزدیک بود ولی همان نبود. وقتی قرار است پالت
	 * «کپی برابر اصل» باشد، نشان هم باید دقیقاً روی همان رنگ بنشیند. یک اختلاف بسیار
	 * کم برای عمق می‌ماند، نه بیشتر.
	 */
	from: '#e08a6b',
	to: '#d0674a',
	/** فیروزه‌ای ایرانی — برای وقتی که نشان روی سطح تیره تک‌رنگ نباشد. */
	turquoise: '#2f9e9b',
};
