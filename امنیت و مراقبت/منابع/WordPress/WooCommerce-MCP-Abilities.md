# MCP و Abilities API در ووکامرس — راهی برای سبک‌تر کردن هوشواره
...
فاز ۱ سند هوشواره (کاتالوگ) و بخشی از فاز ۵ (سفارش) قرار بود ابزار دامنه‌ای بسازیم.
...
## عامل‌های متن‌باز (برای فاز ۰ سند هوشواره)
...
بخش قابل‌توجهی از فاز ۱ و ۵ سند هوشواره را حذف می‌کند، **به شرط اینکه** تعارض امنیتی
